        ...
        while (isRunning) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    int taskId = taskView.userIntInput("Removing task, Please provide an ID:");
                    taskService.removeTask(taskId);
                    break;
                case 3:
                    taskService.getTaskById(taskView.userIntInput("Please provide task ID:"));
                    break;
                case 4:
                ...
                case 0:
                    ...
                    break;
                default:
                    taskView.displayError("Invalid choice, please try again");
                    break;
...
//       }
    public void addTaskfromUserInput() {
        ...
        String description = taskView.userInputText("Please provide description of your new task: ");
        boolean isCompleted = false;
        taskService.addTask(id, description, isCompleted);
        taskView.displayMessage(
            "Your new task has been added to the list, please find via your ID:" + taskService.getAllTasks());
    }
